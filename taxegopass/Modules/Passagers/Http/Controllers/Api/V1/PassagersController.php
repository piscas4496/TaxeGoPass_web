...
class PassagersController extends Controller
{
    ...
    {
        $passagers = Passager::with(['vol'])-> orderBy('id','desc')->paginate(5);
    ...
    public function store(Request $request)
    {
        try {    
            ...
            $passagers->adresse=$request->input('adresse');         
    ...
    {
        $request->validate([
            'nomspass' => 'sometimes|string',
            'genrepass' => 'sometimes|string',
            'datenaisspass' => 'sometimes|date',
            'telephone' => 'sometimes|string',
            'emailpass' => 'sometimes|string',
