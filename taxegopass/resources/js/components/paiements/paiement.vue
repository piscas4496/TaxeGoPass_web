                ...
                <div class="row align-items-center g-2">
                  <div class="col-xl-2 col-md-3">
                    <div class="search-box">
                      <input type="text" class="form-control search" v-model="q"
                  ...
                  <div class="col-xl-2 col-md-3">
                    <div>
                      <input type="date" class="form-control" v-model="date1" id="exampleInputdate"
                  ...
                  <div class="col-xl-2 col-md-3">
                    <div>
                      <input type="date" class="form-control" v-model="date2" id="exampleInputdate"
                        placeholder="Select date range" data-provider="flatpickr" data-date-format="d M, Y"
                        data-range-date="true" />
                    </div>
                  </div>
                  <div class="col-md-auto ms-auto">
                    <div class="hstack gap-2 mt-2 mt-md-0">
                      <button class="btn btn-subtle-info" @click="printallpaiement()">
                        <i class="bi bi-printer"></i>
                      </button>
                      <button class="btn btn-subtle-danger d-none" id="remove-actions">
                        <i class="ri-delete-bin-2-line"></i>
                      </button>
                      <button class="btn btn-info" data-bs-target="#addpaiement" data-bs-toggle="modal">
                        Add Paiement
                      </button>
                      <!-- removeFileItemModal -->
                                ...
                                <form>
                                  <div id="text-form" class="col-md-12 2">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="date" v-model="model.modeldoPaiement.datepaiement
                                        " class="form-control" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <select id="cpn_id" name="passagers" v-model="model.modeldoPaiement.ref_passager
                                        " class="form-control">
                                        <option v-for="(item, index) in this
                                          .passagers" :key="index" :value="item.id">
                                          {{ item.nomspass }}
                                        </option>
                                      </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <select id="cpn_id" name="passagers" v-model="model.modeldoPaiement.ref_agent
                                        " class="form-control">
                                        <option v-for="(itemfagent, index) in this
                                          .agents" :key="index" :value="itemfagent.id">
                                          {{ itemfagent.nomsag }}
                                        </option>
                                      </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <select id="cpn_id" name="passagers" v-model="model.modeldoPaiement.ref_typefrais
                                        " class="form-control">
                                        <option v-for="(itemfrais, index) in this
                                          .typefrais" :key="index" :value="itemfrais.id">
                                          {{ itemfrais.designation }}
                                        </option>
                                      </select>
                                    </div>
                                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                      ...
                                      <button type="button" class="btn w-sm btn-danger" data-bs-dismiss="modal"
                                        aria-hidden="true" @click="savepaiement" id="remove-todoitem">
                                        Save
                                      </button>
                                    </div>
                                  </div>
                  ...
                  <table class="table table-centered align-middle table-custom-effect table-nowrap mb-0">
                    ...
                    <tbody v-if="this.getfilters.length > 0">
                      <tr v-for="(paiement, index) in this.getfilters" :key="index">
                        ...
                        <td>
                          {{ paiement.passager.nomspass }}
                        </td>
                        <td>{{ paiement.motif }}</td>
                        <td>
                          {{ format_date(paiement.created_at) }}
                        </td>
                        <td>
                          {{ paiement.typefrais.designation }}
                        </td>
                        <td>
                          {{ paiement.agent.nomsag }}
                        </td>
                        <td>
                          {{ paiement.typefrais.validite + "mois" }}
                        </td>
                        <td>
                          <button class="btn btn-subtle btn-icon btn-sm remove-item-btn" data-bs-target="#editpaiement"
                            @click="getonepaiement(paiement.id)" data-bs-toggle="modal">
                            <i class="ph-pencil"></i>
                          </button>
                          <!-- removeFileItemModal -->
                                  ...
                                  <form>
                                    <div id="text-form" class="col-md-12 2">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="date" v-model="model.modelPaiement.datepaiement
                                          " class="form-control" />
                                      </div>
                                      <div class="form-group">
                                        <label class="control-label" for="">Passager</label>
                                        <select id="cpnn_id" v-model="model.modelPaiement.ref_passager
                                          " class="form-control">
                                          <!-- <option value="">{{ model.modelPaiement.ref_passager }}</option> -->
                                          <option v-for="(item, index) in this
                                            .passagers" :key="index" :value="item.id">
                                            {{ item.nomspass }}
                                          </option>
                                        </select>
                                        <!-- <input type="text" v-model="model.modelPaiement.ref_passager"
                                          class="form-control" /> -->
                                      </div>

                                      <div class="form-group">
                                        <label class="control-label" for="">Agent</label>
                                        <select id="cpn_iid" name="passagers" v-model="model.modelPaiement.ref_agent
                                          " class="form-control">
                                          <option v-for="(itemfagent, index) in this
                                            .agents" :key="index" :value="itemfagent.id">
                                            {{ itemfagent.nomsag }}
                                      ...
                                      <div class="form-group">
                                        ...
                                        <select id="cpn_id" name="passagers" v-model="model.modelPaiement.ref_typefrais
                                          " class="form-control">
                                          <option v-for="(itemfrais, index) in this
                                            .typefrais" :key="index" :value="itemfrais.id">
                                            {{ itemfrais.designation }}
                                        ...
                                        <!-- <input type="text" v-model="model.modelPaiement.ref_typefrais"
                                          class="form-control" /> -->
                                      </div>
                                      <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                        <button type="button" class="btn w-sm btn-light" data-bs-dismiss="modal">
                                        ...
                                        <button type="button" class="btn w-sm btn-danger" data-bs-dismiss="modal"
                                          @click="update" id="remove-todoitem">
                                          Update
                                        </button>
                                      </div>
                                    </div>
                          ...
                          <a class="btn btn-subtle btn-icon btn-sm remove-item-btn" @click="deletePaiement(paiement.id)"
                            data-bs-target="" data-bs-toggle="">
                            <i class="ph-trash"></i></a>

                          <a class="btn btn-subtle btn-icon btn-sm remove-item-btn" @click="printBill(paiement.id)"
                            data-bs-target="" data-bs-toggle="">
                ...
                <div class="row align-items-center mt-4 pt-3" id="pagination-element">
                  ...
                  <div class="col-sm-auto mt-3 mt-sm-0">
                    <div class="pagination-wrap hstack justify-content-center gap-2">
                      ...
                      <pagination :data="paiements" @pagination-change-page="getpaiement"></pagination>
                    </div>
                  </div>
                </div>
              </div>
...
export default {
  ...
  data() {
    return {
      ...
      model: {
        modelPaiement:
        {
          id: "", motif: "", datepaiement: "", ref_passager: "", ref_agent: "", ref_typefrais: "", created_at: "",
        },
        modeldoPaiement:
        {
           motif: "", datepaiement: "", ref_passager: "", ref_agent: "", ref_typefrais: "",
        },
        modelfrais: 
        {
          designation: "", prix: "", validite: "",
        },
      },
    };
  },
  ...
  methods: {
    ...
    FormatDate(datepaiement) {
      return new Date(datepaiement).toDateString();
    },
    FormatHeure(date) {
    ...
    async getpaiement() {
      await axios
        .get(`http://127.0.0.1:8000/api/v1/paiement/paiement`)
        .then((res) => {
    ...
    getAllfrais() {
      axios
        .get("http://127.0.0.1:8000/api/v1/paiement/typefrais")
        .then((res) => {
    ...
    savepaiement() {
      axios
        .post(
          "http://127.0.0.1:8000/api/v1/paiement/paiement",
    ...
    addtypefrais() {
      axios
        .post(
          "http://127.0.0.1:8000/api/v1/paiement/typefrais",
    ...
    async getonepaiement(idpaiement) {
      await axios
        .get(`http://127.0.0.1:8000/api/v1/paiement/editbyid/${idpaiement}`)
        .then((response) => {
          ...
          this.model.modelPaiement.ref_typefrais =
            response.data.typefrais.designation;
    ...
    update(idpaiement) {
      axios
        .put(
          `http://127.0.0.1:8000/api/v1/paiement/update/${this.model.modelPaiement.id}`,
          {
            motif: this.model.modelPaiement.motif,
            datepaiement: this.model.modelPaiement.datepaiement,
            ref_typefrais: this.model.modelPaiement.ref_typefrais,
            ref_passager: this.model.modelPaiement.ref_passager,
            ref_agent: this.model.modelPaiement.ref_agent,
          }
        )
        .then((response) => {
    ...
    deletePaiement(id) {
      if (confirm("Are you sure to delete this Paiement ?")) {
        axios
          .delete(`http://127.0.0.1:8000/api/v1/paiement/paiement/${id}`)
          .then((response) => {
            this.getpaiement();
          })
          .catch((error) => {
    ...
    printBill(id) {
      window.open(
        `http://127.0.0.1:8000/api/v1/paiement/pdf_paiement?id=` + id
      );
    },

    printallpaiement() {
      var date11 = this.date1;
      var date12 = this.date2;
      // @ts-ignore
      if (this.date1 <= this.date2) {
        window.open(
          `http://127.0.0.1:8000/api/v1/paiement/pdf_allpaiement/${this.date1}/${this.date2}`
        );
      } else {
        console.log("err");
      }
  ...
  computed: {
    ...
    getfilters() {
      return this.paiements.filter((
          /** @type {{ passager: { nomspass: string; }; }} */ paiement
      ) => {
        return paiement.passager.nomspass
          .toLowerCase()
